...
export default function Home() {
  return <main id="main-content">
    <section className="px-4 pb-2 pt-4"><div className="site-grid home-hero-grid items-stretch"><div className="flex flex-col justify-end gap-6 py-4 md:gap-10 md:py-16">
      <HeroTitle />
    ...
    <section className="px-4 pb-10 md:pb-16"><div className="image-frame relative aspect-[2/1]"><Image src={asset("media/tedx-stage-original.png")} alt="Chris Bleeker op het podium bij TEDxEindhoven" fill sizes="100vw" className="object-cover" priority /></div></section>
